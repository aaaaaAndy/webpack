...
/**
 * Compiler和Compilation是webpack的两大引擎，此处是Compilation引擎
 * 代表了一次单一的版本构建和生成资源，compilation作业可以多次执行
 * 如果当前webpack工作在watch模式下时，每次监测到资源文件发生变化时，都会重新实例化一个Compilation对象。
 * 一个Compilation实例表现了当前的模块资源，编译生成资源，变化的文件，以及被跟踪依赖的状态信息。
 */
